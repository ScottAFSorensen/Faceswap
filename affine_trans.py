...
def morph_affine(tri_1, tri_2, orig_img, morphed_image):
    ...
    shape1 = ((1.0, 1.0, 1.0) - mask).shape
    shape2 = morphed_image[y_2:y_2 + h_2, x_2:x_2 + w_2].shape
    print("shape of mask and 1,1,1 is: ", ((1.0, 1.0, 1.0) - mask).shape)
    print("morph shape:", morphed_image[y_2:y_2 + h_2, x_2:x_2 + w_2].shape)
    print("trans triang shape: ", transformed_triangle_only.shape)
